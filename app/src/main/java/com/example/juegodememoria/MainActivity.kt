  ...
  class MainActivity : AppCompatActivity(){
    ...
    fun onClick(v: View){
      ...
      fun bloquearBotones(ok : Boolean, uno : Int, dos : Int){
          var cartas = mutableListOf(R.id.tarjeta1, R.id.tarjeta2, R.id.tarjeta3, R.id.tarjeta4,
              R.id.tarjeta5, R.id.tarjeta6, R.id.tarjeta7, R.id.tarjeta8,
              R.id.tarjeta9,R.id.tarjeta10 ,R.id.tarjeta11 ,R.id.tarjeta12,
      ...
      fun buscandoPares(valorClick : Int) {
          if (validadorClick && !cartasDescubiertas.contains(valorClick)) {
              ...
              validadorClick = true; // ABRE LA ENTRADA AL IF PARA GUARDAR PRIMER CLICK EN seleccionUno
              bloquearBotones(false,seleccionUno.getId(),seleccionDos.getId()); // BLOQUEA LOS BOTONES QUE NO HAYAN SIDO CLICKEADOS
